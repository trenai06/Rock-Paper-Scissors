...
/* 6. Player makes a choice. get the value of the choice to compare to the computer "String" */
    ...
    function gameResults(){
        ...
        if (button === computerAnswer){
            document.getElementById("submit").innerHTML = (`It's a tie!!`)
        } else if (button === "Rock" && computerAnswer === "Paper"){
            document.getElementById("submit").innerHTML = (`Sorry, Paper covers rock!`)
            document.getElementById("computer-score").innerHTML = computerScore.pop()
        } else if (button === "Paper" && computerAnswer === "Scissors"){
            document.getElementById("submit").innerHTML = (`Sorry, Scissors cut paper!`)
            document.getElementById("computer-score").innerHTML = computerScore.pop()
        } else if (button === "Scissors" && computerAnswer === `Rock`){
            document.getElementById("submit").innerHTML = (`Sorry, Rock smashes scissors!`)
            document.getElementById("computer-score").innerHTML = computerScore.pop()
        } else if(button === "Rock" && computerAnswer === "Scissors"){
            document.getElementById("submit").innerHTML = (`Yes! Rock smashes scissors!`)
            document.getElementById("player-score").innerHTML = playerScore.pop()
        } else if(button === "Scissors" && computerAnswer === "Paper"){
            document.getElementById("submit").innerHTML = (`Yes! Scissors cut paper!`)
            document.getElementById("player-score").innerHTML = playerScore.pop()
        } else if(button === "Paper" && computerAnswer === "Rock"){
            document.getElementById("submit").innerHTML = (`Yes! Paper covers rock!`)
            document.getElementById("player-score").innerHTML = playerScore.pop()
        } else{
        ...
        // 8. only three rounds and then game is refreshed
    ...
    //9. a way to reset the game after a choice without refreshing score 
